...
saliva_counts_imputed_0 <- saliva_counts_imputed[, marker_KO]
...
saveRDS(output, "lasso_logistic/KEGG/saliva_yr1.rds")




# visualize the results
combined_results <- readRDS("lasso_logistic/KEGG/saliva_yr1.rds")
