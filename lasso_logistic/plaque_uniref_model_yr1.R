...
plaque_counts_imputed_0 <- plaque_counts_imputed[, marker_uniref]


source("lasso_logistic/codalasso_utils.R")
lambdas_0 <- c(0.1, 0.15,  0.2, 0.25, 0.3)
...
subset_features <- which(selection_frequency_1 > 0.9)
...
saveRDS(output, "lasso_logistic/uniref/plaque_yr1.rds")



# visualize the results
combined_results <- readRDS("lasso_logistic/uniref/plaque_yr1.rds")
