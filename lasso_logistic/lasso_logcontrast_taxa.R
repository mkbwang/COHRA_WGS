...
saliva_relabd <- readRDS("lasso_logistic/feature_filter_taxa/saliva_relabd_imputed.rds")
plaque_relabd <- readRDS("lasso_logistic/feature_filter_taxa/plaque_relabd_imputed.rds")
...
codalasso_saliva <- lambda_tune(y=diagnoses_1, lambdas=seq(0.4, 1.0, 0.1), X=saliva_relabd)
saveRDS(codalasso_saliva, file="lasso_logistic/feature_filter_taxa/codalasso_saliva.rds")

codalasso_plaque <- lambda_tune(y=diagnoses_2, lambdas=seq(0.4, 1.0, 0.1), X=plaque_relabd)
