...
library(pROC)
AUCs <- matrix(0, nrow=100, ncol=7)
frequency_cutoffs <- c(0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4)
variables_selected <- rep("", 7)
...
saveRDS(predictive_features,
        "lasso_logistic/KEGG/plaque_predictive_features_yr1.rds")
