...
# modified by Mukai Wang in 2024 for removing spike in species
...
echo "There are ${THREADS} threads"
#OUTDIR=bowtie2
...
FASTQBASENAME=$(basename "${FASTQTRIMMEDPAIRED1}" | cut -d'_' -f1)



echo PROGRESS: Removing spikein species from paired reads.
...
echo PROGRESS: Removing spikein species from unpaired reads.
