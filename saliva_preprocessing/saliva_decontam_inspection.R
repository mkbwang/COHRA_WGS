...
stats_with_spikein = read.table("saliva_preprocessing/stats_with_spikein.tsv", 
                                header=T)
...
stats_without_spikein = read.table("saliva_preprocessing/stats_without_spikein.tsv",
                                   header=T)
...
write.table(seq_count_combined, "saliva_preprocessing/saliva_spikein_removal_details.tsv",
